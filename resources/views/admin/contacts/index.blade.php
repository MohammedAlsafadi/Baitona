                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body pb-5 px-sm-5 pt-50">
                        <div class="text-center mb-2">
                            <h1 class="mb-1">@lang('common.add') @lang('common.contact')</h1>
                        </div>
                        <form id="create_form" data-reset="true" method="POST" class="row gy-1 pt-75 ajax_form"
                            ...
                            @csrf
                              ...
                              @foreach (locales() as $key => $value)
                                <div class="col-12 col-md-6">
                                    ...
                                    <input type="text" id="name_{{ $key }}" name="name_{{ $key }}"
                                        class="form-control"
                          ...
                          <div class="col-12 col-md-6">
                            ...
                            <div class="col-12 col-md-6">
                                ...
                                <input type="text" id="message_{{ $key }}"
                                    name="message_{{ $key }}" class="form-control"
                                    placeholder="{{ __('common.message') . ' - ' . __('common.' . $value) }}" />
                                <div class="invalid-feedback"></div>
                            </div>
                        @endforeach
                            <div class="col-12 col-md-6">
        ...
        <div class="modal fade" id="editUser" tabindex="-1" aria-hidden="true">
            <div class="modal-dialog modal-lg modal-dialog-centered modal-edit-user">
                <div class="modal-content">
                    ...
                    <div class="modal-body pb-5 px-sm-5 pt-50">
                        <div class="text-center mb-2">
                            <h1 class="mb-1">@lang('common.edit') @lang('common.contact')</h1>
                        </div>
                        <form id="editUserForm" data-reset="true" method="POST" class="row gy-1 pt-75 ajax_form"
                            ...
                            @foreach (locales() as $key => $value)
                                <div class="col-12 col-md-6">
                                    ...
                                    <input type="text" id="edit_name_{{ $key }}"
                                        name="name_{{ $key }}" class="form-control"
                                        placeholder="{{ __('common.name') . ' - ' . __('common.' . $value) }}" />
                                    <div class="invalid-feedback"></div>
                                </div>
                            @endforeach
                            ...
                            <div class="col-12 col-md-6">
                                ...
                                <input type="email" id="edit_mobile" name="mobile" class="form-control"
                                    placeholder="{{ __('common.mobile') }}" />
                                <div class="invalid-feedback"></div>
                            </div>
                            @foreach (locales() as $key => $value)
                                <div class="col-12 col-md-6">
                                    ...
                                    <textarea type="text" id="edit_message_{{ $key }}" name="message_{{ $key }}"
                                        class="form-control" placeholder="{{ __('common.message') . ' - ' . __('common.' . "$value") }}"></textarea>
                                    <div class="invalid-feedback"></div>
                                </div>
                            @endforeach
