...
@section('main-content')
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">@lang('common.videos')</h4>
                </div>
                <div class="card-body">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body pb-5 px-sm-5 pt-50">
                        <div class="text-center mb-2">
                            <h1 class="mb-1">@lang('common.add') @lang('common.video')</h1>
                        </div>
                        <form id="create_form" data-reset="true" method="POST" class="row gy-1 pt-75 ajax_form"
                            ...
                            <div class="col-12 col-md-6">
                                <label class="form-label" for="video">{{ __('common.video') }}</label>
                                <input type="file" id="video" name="video" class="form-control"
                                    placeholder="{{ __('common.video') }}" />
                                    <div class="invalid-feedback"></div>
                            </div>
        ...
        <div class="modal fade" id="editUser" tabindex="-1" aria-hidden="true">
            <div class="modal-dialog modal-lg modal-dialog-centered modal-edit-user">
                <div class="modal-content">
                    ...
                    <div class="modal-body pb-5 px-sm-5 pt-50">
                        <div class="text-center mb-2">
                            <h1 class="mb-1">@lang('common.edit') @lang('common.video')</h1>
                        </div>
                        <form id="editUserForm" data-reset="true" method="POST" class="row gy-1 pt-75 ajax_form"
                            ...
                            @endforeach
                            <div class="col-12 col-md-6">
                                <label class="form-label" for="edit_link">Link-video</label>
                                <input type="url" id="edit_link" name="link" class="form-control"
                                    placeholder="{{ __('common.link') }}" />
                                    <div class="invalid-feedback"></div>
                            </div>
                            <div class="col-12 col-md-6">
                                <label class="form-label" for="edit_video">{{ __('common.video') }}</label>
    ...
    @section('scripts')
        ...
        <script>
            var url = '{{ url(app()->getLocale() . '/admin/videos/') }}/';
            ...
            var dt_adv_filter = $('#datatable').DataTable({
                "oLanguage": {
                    ...
                    "sInfo": "@lang('common.showing') START @lang('common.to') END @lang('common.from') @lang('common.origin') TOTAL @lang('common.entered')",
                    "sSearch": '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-search"><circle cx="11" cy="11" r="8"></circle><line x1="21" y1="21" x2="16.65" y2="16.65"></line></svg>',
                    "sSearchPlaceholder": "@lang('common.search')",
                    "sLengthMenu": "@lang('common.show') MENU @lang('common.data')",
                },
                'columnDefs': [{
                        "targets": 1,
                        "visible": false
                ...
                columns: [{
                    ...
                    // },
                    {
                        data: 'id',
                        'render': function(data, type, full, meta) {
                            return '<video autoplay muted src="' + full.video + '" style="width: 100px;">';
                        }
                    },
                    {
                        data: 'action',
            ...
            $(document).ready(function() {
                ...
                $(document).on('click', '.edit_btn', function(event) {
                    ...
                    $('#show_video ').attr('src', button.data('video '));
                });

                $(document).on('click', '#create_btn', function(event) {
                    $('#create_form').attr('action', '{{ route('videos.store') }}');
                });
            });
