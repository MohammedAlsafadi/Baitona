                ...
                <div class="auth-wrapper auth-cover">
                    <div class="auth-inner row m-0">
                        <!-- Brand logo--><a class="brand-logo" href="index.html">
                            <img src="{{ asset('assets/app-assets/images/logo/Group-12.png') }}" height="50" alt="" >
                        ...
                        <div class="d-none d-lg-flex col-lg-8 align-items-center p-5">
                            <div class="w-100 d-lg-flex align-items-center justify-content-center px-5"><img
                                    class="img-fluid"
                                    src="{{ asset('assets/app-assets/images/pages/Group-5.svg') }}"
                                    alt="Login V2" /></div>
                        </div>
                        <!-- /Left Text-->
                        <!-- Login-->
                        <div class="d-flex col-lg-4 align-items-center auth-bg px-2 p-lg-5">
                            ...
                            <img src="{{ asset('assets/app-assets/images/ico/log-ico.png') }}" height="300"  alt="log" >
                                <h2 class="card-title fw-bold mb-1">Welcome to Baitona 👋</h2>
                                ...
                                <form class="auth-login-form mt-2" action="{{ route('admin.login') }}"
                                    ...
                                    <button class="btn btn-primary w-100" type="submit" tabindex="4">Sign
                                        in</button>
                                </form>
                            </div>
                        </div>
